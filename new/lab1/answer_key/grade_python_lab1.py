import unittest
import example_python_lab1

class Lab1UnitTests(unittest.TestCase):
    def test_question_1(self):
        expected = 5
        actual = example_python_lab1.question_1()
        self.assertEqual(expected, actual)
    
    def test_question_2(self):
        expected = ["3.2", 'python', 9.8]
        actual = example_python_lab1.question_2()
        self.assertListEqual(expected, actual)
    
    def test_question_3(self):
        expected = 25
        actual = example_python_lab1.question_3()
        self.assertEqual(expected, actual)
    
    def test_question_4(self):
        expected = "python rocks"
        actual = example_python_lab1.question_4()
        self.assertEqual(expected, actual)
    
    def test_question_5(self):
        expected = 5.2
        actual = example_python_lab1.question_5()
        self.assertEqual(expected, actual)
    
    def test_question_6(self):
        expected = "9.825"
        actual = example_python_lab1.question_6()
        self.assertEqual(expected, actual)

    def test_question_7(self):
        expected = str
        actual = example_python_lab1.question_7()
        self.assertEqual(expected, actual)
    
    def test_question_8(self):
        expected = 3.2
        actual = example_python_lab1.question_8()
        self.assertEqual(expected, actual)
    
    def test_question_9(self):
        expected = "The Earth is ROUND"
        actual = example_python_lab1.question_9()
        self.assertEqual(expected, actual)

    def test_question_10(self):
        expected = "hello"
        actual = example_python_lab1.question_10()
        self.assertEqual(expected, actual)
    
    def test_question_11(self):
        expected = "This PC costs $1999.00"
        actual = example_python_lab1.question_11()
        self.assertEqual(expected, actual)
    ...
    def test_question_17(self):
        ...
        a1, a2, a3 = example_python_lab1.question_17()
        self.assertTrue(e1 == a1 and e2 == a2 and e3 == a3)

    def test_question_18(self):
        expected = 10
        actual = example_python_lab1.question_18()
        self.assertEqual(expected, actual)
    
    def test_question_19(self):
        e1, e2, e3 = 5, 8, 11
        a1, a2, a3 = example_python_lab1.question_19()
        self.assertTrue(e1 == a1 and e2 == a2 and e3 == a3)
    
    def test_question_20(self):
        expected = 13
        actual = example_python_lab1.question_20()
        self.assertEqual(expected, actual)
    
    def test_question_21(self):
        expected = "192.168.1.15"
        actual = example_python_lab1.question_21(example_python_lab1.HEXDUMP_IP)
        self.assertEqual(expected, actual)
    
    def test_question_22(self):
        expected = {'src_ip': '192.168.1.15', 'dst_ip': '192.168.1.1', 'src_port': 63612, 'dst_port': 443}
        actual = example_python_lab1.question_22(example_python_lab1.HEXDUMP)
        self.assertDictEqual(expected, actual)
