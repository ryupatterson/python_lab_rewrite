...
# Write a function that writes an example dictionary to disk in json format, and reads it back
...
def write_json()->bool:
    ...
    with open(filename, 'w') as outfile:
        outfile.write(json.dump(example_dict, indent=4))
    
    json_obj = dict()
    with open(filename, "r") as infile:
        json_obj = json.loads(infile)
...
if __name__ == "__main__":
    try:
        ...
        current_files = os.listdir() # taking accountability of files currently in the directory
