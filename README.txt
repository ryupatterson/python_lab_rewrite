When running these files, please try and run them in the directory where the python file exists. Although they were written so that this probably won't be an issue, if you encounter any errors please check what directory you are in. Each lab has an answer_key directory. These will have a completed version of each lab. Please do not look at these until you have actually attempted to complete the labs yourselves. 
...
Lab 3: Directory Enumeration and File Manipulation
    ...
    - there are no unit tests for this lab, the lab script gives you an opportunity to validate your answers when you run it
